...
(function ($) {
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      $('#preview #preview-main h2', form).css('background', $('#palette input[name="palette[bg]"]', form).val());
      $('#preview #preview-main-menu a', form).css('background', $('#palette input[name="palette[menu45]"]', form).val());
